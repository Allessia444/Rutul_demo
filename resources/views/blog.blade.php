											...
											<div class="row no-gutters">
												...
												<div class="col-lg-8 col-md-12 col-sm-12">
													<div class="blog-caption">
														...
														<h4><a href="#">{!! $blog->blog_category->name !!}</a></h4>
														<div class="blog-by">
															<p>{!! $blog->description !!}</p>
															<h5 class="text-right">-{!! $blog->user->fname !!}</h5>
															<div class="pt-10">
																<a href="{{ route('blog_detail', $blog->id) }}" class="btn btn-outline-primary">Read More</a>
															</div>
														</div>
							...
							<div class="col-md-4 col-sm-12">
								<div class="bg-white border-radius-4 box-shadow mb-30">
									...
									<div class="list-group">
										...
										<a href="{{ route('blog', ['slug' => $blog_category->slug]) }}" class="list-group-item d-flex align-items-center justify-content-between">{!! $blog_category->name !!}<span class="badge badge-primary badge-pill">{!! $blog_category->blog->count() !!}</span></a>
										@endforeach	
									</div>
									<div class="bg-white border-radius-4 box-shadow mb-30">
