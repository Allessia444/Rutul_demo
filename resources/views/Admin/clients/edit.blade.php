	...
	<div class="pd-ltr-20 customscroll-10-p height-100-p xs-pd-20-10">
		<div class="min-height-200px">
			...
			<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
				<div class="clearfix">
					<div class="pull-left">
						<h4 class="text-blue">Update Client</h4>
				...
				<img src="{!! asset('/logo/'.$client->logo) !!}">


				<div id="container">
					<div id="previewDiv"></div>

					<input type="hidden" name="logo" value="{!! $client->logo !!}" id="file">
				...
				{!! Former::submit('btn_edit_client')->class('btn btn-outline-success')->value('Update') !!}
