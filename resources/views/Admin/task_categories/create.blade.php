...
@section('title','Add Task Category')
@section('content')
	...
	<div class="pd-ltr-20 customscroll-10-p height-100-p xs-pd-20-10">
		<div class="min-height-200px">
					...
					<div class="col-md-6 col-sm-12">
						...
						<nav aria-label="breadcrumb" role="navigation">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Add TaskCategory</li>
							</ol>
						</nav>
					</div>
			...
			<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
				...
				{!! Former::open()->route('task_categories.store') !!}
				
				@csrf

				{!! Former::input('name')->class('form-control')->label('Task Category name') !!}

				{!! Former::submit('btnaddtaskcat')->class('btn btn-outline-success')->value('Add') !!}
