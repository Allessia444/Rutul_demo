	...
	<div class="pd-ltr-20 customscroll-10-p height-100-p xs-pd-20-10">
		<div class="min-height-200px">
			...
			<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
				<div class="clearfix">
					<div class="pull-left">
						<h4 class="text-blue">Edit Designation</h4>
						<p class="mb-30 font-14"></p>
					</div>
				</div>

				{!! Former::open()->method('PATCH')->action(route('designations.update',$designation->id)) !!}

				@csrf

				{!! Former::text('name')->class('form-control')->label('Designation name') !!}

				{!! Former::submit('btneditdesig')->class('btn btn-outline-success')->value('Update') !!}
